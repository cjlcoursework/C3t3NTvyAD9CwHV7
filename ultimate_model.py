...
def create_ultimate_origin_model(input_shape,
    ...
    model = Sequential()
    model.add(
        Dense(64, input_dim=input_shape, activation=activation_function, kernel_regularizer=regularization_function))
...
def create_ultimate_model(input_shape,
    ...
    model = Sequential()
    model.add(
        Dense(266, input_dim=input_shape, activation=activation_function, kernel_regularizer=regularization_function))
